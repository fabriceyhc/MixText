...
from read_data_fhc import *
from mixtext import MixText


parser = argparse.ArgumentParser(description='PyTorch MixText')
parser.add_argument('--task', default='yahoo_answers_topics', type=str,
                    help='task name')
...
parser.add_argument('--un-labeled', default=0, type=int,
...
def main():
    ...
    train_labeled_set, train_unlabeled_set, val_set, test_set, n_labels = get_data(
        args.task, args.n_labeled, args.un_labeled, model=args.model, train_aug=args.train_aug)
